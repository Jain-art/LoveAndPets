...
namespace LoveAndPets.Infrastructure.Guarantors
{
    ...
    public class SeedDataGuarantor
    {
        ...
        {
            var context = _serviceProvider.GetService<AnimalDbContext>();
        ...
        private static async Task AssertRoleExistenceAsync(RoleManager<IdentityRole<int>> roleManager, AnimalDbContext context)
        {
