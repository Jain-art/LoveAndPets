...
namespace LoveAndPets.Controllers
{
    public class AccountController : Controller
    {
        ...
        private readonly AnimalDbContext _blogDbContext;

        /// <summary>
        /// Конструктор класса <see cref="AccountController"/>
        /// </summary>
        /// <param name="userManager">Менеджер пользователей</param>
        /// <param name="AnimalDbContext">Контекст базы данных</param>
        public AccountController(UserManager<User> userManager, AnimalDbContext blogDbContext)
        {
