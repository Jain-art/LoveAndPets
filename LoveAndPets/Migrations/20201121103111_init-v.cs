        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeEntitys = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Employees_EmployeeEntitys",
                        column: x => x.EmployeeEntitys,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_EmployeeEntitys",
                table: "AspNetUsers",
                column: "EmployeeEntitys",
                unique: true);
